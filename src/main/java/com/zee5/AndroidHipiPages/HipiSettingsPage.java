	...
	//Search Field in help center	
		...
		//Search result
			...
			//terms of use back button 
					...
					public static By objShareOptionsSettings=By.xpath("//*[@resource-id='android:id/text1'] | //*[@resource-id='vivo:id/text1'] | //*[@resource-id='oppo:id/resolver_item_name'] | //*[@resource-id='com.zee5.hipi:id/title']");

					public static By objShareoptionsSettings(int index) {
						return By.xpath("(//*[@resource-id='android:id/text1'] | //*[@resource-id='vivo:id/text1'] | //*[@resource-id='com.zee5.hipi:id/title'] | //*[@resource-id='oppo:id/resolver_item_name'])[" + index + "]");
					}					
					...
					public static By objContentLanguageOption=By.xpath("//*[contains(@text,'Content la')]");
					...
					public static By objDataSaverConent=By.xpath("//*[@resource-id='com.zee5.hipi:id/tvPrvtAcntHint']");
							...
							public static By objLanguageSelect(int index) {
								return By.xpath("(//*[@resource-id='com.zee5.hipi:id/languageThumbnail'])[" + index + "]");
							}
							//public static By objLanguageSelect = By.xpath("//*[@resource-id='com.zee5.hipi:id/languageThumbnail']");
							public static By objLangCheckBox = By.xpath("//*[@resource-id='com.zee5.hipi:id/languageCheckbox']");
							
							public static By objDoneCta = By.xpath("//*[@resource-id='com.zee5.hipi:id/content_done']");
							
							public static By objCreatorSelect = By.xpath("//*[contains(@text,'Creator Se')]");
							
							public static By objCreatorSelectHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvTitle' and contains(@text,'Creator')]");
							
							public static By objCreatorSelectThumbnail = By.xpath("//*[@resource-id='com.zee5.hipi:id/ivSetup']");
							
							public static By objMonetizeTxt = By.xpath("//*[contains(@text,'Monet')]");
							
							public static By objAgeRadioBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/rbAge' and @checked='true']");
							
							public static By objFollowersRadioBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/rbFollowers']");
							
							public static By objVideoViewsRadioBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/rbVideoViews']");
							
							public static By objAcknowldgeText = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvAcknowledge']");
							
							public static By objAcknowledgeRadioBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/rbAcknowledge' and @checked='false']");
							
							public static By objApplyBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/btnApply']");
							
							public static By objProgramAgreementPage = By.xpath("//*[@resource-id='com.zee5.hipi:id/title' and contains(@text,'agreement')]");
							
							public static By objCoinsOption = By.xpath("//*[contains(@text,'Coins')]");
							
							public static By objRedeemCoinsBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/seeYourRewardsButton']");
							
							public static By objLinkPaytmHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/rewards_text' and contains(@text,'Link')]");
							
							public static By objCoinsBalanceValue = By.xpath("//*[@resource-id='com.zee5.hipi:id/coinBalanceTextView']");
							
							public static By objCoinsBalanceTxt = By.xpath("//*[contains(@text,'balance')]");
							
							public static By objCoinsHistory = By.xpath("//*[contains(@text,'History')]");
							
							public static By objContentComplaintsOption = By.xpath("//*[contains(@text,'Compl')]");
							
							public static By objSupportEmailOption = By.xpath("//*[contains(@text,'Support Email')]");
