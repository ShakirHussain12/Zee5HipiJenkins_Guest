...
public class HipiSoundDetailPage {
	...
	public static By objShareIcon =By.xpath("(//*[@class='android.widget.ImageButton'])[1] | //*[@resource-id='com.zee5.hipi:id/imgShare']");
	...
	public static By objHipiSoundSharePopUp = By.xpath("//*[@text='HiPi Sound'] | //*[@text='Share to']");
	
	public static By objFacebookPost = By.xpath("//*[@text='POST' or @text='Post' or @text='Share' or @text='SHARE']");

	public static By objUseThisSoundBtn = By.xpath("//*[@text and ./parent::*[@id='createVideo']] | //*[contains(@text,'Use this')]");
...
//==================================================Kartheek===============================================
		...
		//Added To Favorite	
			...
			public static By objCreatorTxt = By.xpath("//*[@resource-id='com.zee5.hipi:id/txtCreator']");
			
			public static By objSoundsTab = By.xpath("//*[@text='Sounds']");
			
			public static By objFavsOption = By.xpath("//*[@resource-id='com.zee5.hipi:id/imgOption']");
			
			public static By objOriginalAudio = By.xpath("//*[contains(@text,'Audio')]");
