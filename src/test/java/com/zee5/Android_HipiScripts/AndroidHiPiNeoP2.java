...
//		Zee5ApplicasterHipiNeoBusinessLogic.userShouldBeLandedOnINTHISVIDEOTab__T313__T323(userType);
	...
	{	
		...
		Zee5ApplicasterHipiNeoBusinessLogic.verifyUIRailOfContentLoggedInUser__T1578(userType);
				...
				Zee5ApplicasterHipiNeoBusinessLogic.VerifyFollowingList__T1381(userType);
		////		Zee5ApplicasterHipiNeoBusinessLogic.VerifySEarchFieldInListOfFollowing__T1382(userType);//Invalide Steps	
				Zee5ApplicasterHipiNeoBusinessLogic.VerifyUserAbleToEnterDataInFollowingTab__T1383(userType);
...
//Zee5ApplicasterHipiNeoBusinessLogic.CheckTheUIOfFeedScreenForAShoppableVideo_T1934(userType); Inactive Shop
	...
	@Test(priority = 17)
	@Parameters({ "userType"})
	public void loginSignUpP2New(String userType) throws Exception {
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
	...
	@Test(priority = 18)
	@Parameters({"userType"})
	public void discoverModuleP2New(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		
		Zee5ApplicasterHipiNeoBusinessLogic.bannerDetailsScrollingDiscover__T3435_T3460(userType, userType);
		Zee5ApplicasterHipiNeoBusinessLogic.productCategroiesRailDiscover__T3439_T3464(userType, userType);
	}
	
	@Test(priority=19)
	@Parameters({"userType"})
	public void SoundDetailsModuleP2(String userType) throws Exception {
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
